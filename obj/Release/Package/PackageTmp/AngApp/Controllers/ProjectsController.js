...
app.controller('ProjectsController', ['$scope', '$location', '$http', '$timeout', '$filter',
    function ($scope, $location, $http, $timeout, $filter) {       
        ...
        $scope.users = [];
        $http({
            url: "/api/Projects/GetProjectsList",
            method: "GET",
            headers: authHeaders
        ...
        $scope.saveUser = function (data, id) {
            ...
            if (id == 0) {
                $http({
                    ...
                    $scope.message = "Successfully Project Created.";
                    $scope.messageType = "success";
                    $scope.clientMessage = false;
                    $timeout(function () { $scope.clientMessage = true; }, 5000);
                }).error(function (error) {
                    $scope.message = 'Unable to save Project' + error.message;
                ...
                $http({
                    ...
                    //alert('Updated');
                    $scope.message = "Successfully Project Updated.";
                    $scope.messageType = "success";
                    $scope.clientMessage = false;
                    $timeout(function () { $scope.clientMessage = true; }, 5000);
                }).error(function (error) {
