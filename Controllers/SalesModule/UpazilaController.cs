    ...
    public class UpazilaController : ApiController
    {
        ...
        public IHttpActionResult GetDistrictList()
        {
            ...
            string queryString = @"SELECT        
                                        dbo.Upazilas.UpazilaId AS id, dbo.Upazilas.UpazilaName AS name, dbo.Upazilas.DistrictId AS [group], dbo.Districts.DistrictName AS groupName
                                    FROM            
                                        dbo.Upazilas 
                                    INNER JOIN
        ...
        {
            var list = db.Upazilas.Select(e => new { UpazilaId = e.UpazilaId, UpazilaName = e.UpazilaName });
            if (list == null)
            {
                return NotFound();
            }
