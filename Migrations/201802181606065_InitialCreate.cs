    ...
    public partial class InitialCreate : DbMigration
    {
        public override void Up()
        {
            ...
            CreateTable(
                ...
                .ForeignKey("dbo.CheckBookPages", t => t.CheckBookPageId, cascadeDelete: false)
                .ForeignKey("dbo.Ledgers", t => t.LedgerId, cascadeDelete: false)
            ...
            CreateTable(
                ...
                .ForeignKey("dbo.Ledgers", t => t.LedgerId, cascadeDelete: false)
                .ForeignKey("dbo.TransctionTypes", t => t.TransctionTypeId, cascadeDelete: false)
                .ForeignKey("dbo.Vouchers", t => t.VoucherId, cascadeDelete: true)
                .Index(t => t.VoucherId)
                .Index(t => t.LedgerId)
            ...
            CreateTable(
                ...
                .ForeignKey("dbo.Matrics", t => t.MatricId, cascadeDelete: false)
