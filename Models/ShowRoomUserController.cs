...
{
    [Authorize]
    public class ShowRoomUserController : ApiController
    {
        private PCBookWebAppContext db = new PCBookWebAppContext();


        [Route("api/ShowRoomUser/GetUsersDropDownList")]
        [HttpGet]
        ...
        [Route("api/ShowRoomUser/ShowRoomOfficerList")]
        [HttpGet]
